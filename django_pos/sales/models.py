...
from products.models import Product, Store, StoreInventory
...
class Sale(models.Model):
    ...
    employee = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, null=True, blank=True)  # Link to the User model or your Employee model
...
class SaleDetail(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        store_inventory = StoreInventory.objects.get(store=self.sale.store, product=self.product)
